...
public class ReceiptStatusServiceIMpl implements ReceiptStatusService {
    ...
    public ReceiptStatusDto getReceiptStatus(Integer id) {
        ...
        ReceiptStatus receiptStatus =
            receiptStatusRepository.getReceiptStatus(id);
    ...
    public List<ReceiptStatusDto> getAllReceiptStatuses() {
        ...
        return receiptStatusRepository.getAllReceiptStatuses()
            .stream()
    ...
    public ReceiptStatusDto createReceiptStatus(
        ReceiptStatusDto receiptStatusDto) {
        log.info("create receiptStatus with id {}", receiptStatusDto.getId());
        ReceiptStatus receiptStatus =
            mapReceiptStatusDtoToReceiptStatus(receiptStatusDto);
        receiptStatus =
            receiptStatusRepository.createReceiptStatus(receiptStatus);
        return mapReceiptStatusToReceiptStatusDto(receiptStatus);
    }

    @Override
    public ReceiptStatusDto updateReceiptStatus(
        Integer id, ReceiptStatusDto receiptStatusDto) {
        log.info("update receiptStatus with id {}", id);
        ReceiptStatus receiptStatus =
            mapReceiptStatusDtoToReceiptStatus(receiptStatusDto);
        receiptStatus =
            receiptStatusRepository.updateReceiptStatus(id, receiptStatus);
        return mapReceiptStatusToReceiptStatusDto(receiptStatus);
    }

    private ReceiptStatusDto mapReceiptStatusToReceiptStatusDto(
        ReceiptStatus receiptStatus) {
    ...
    private ReceiptStatus mapReceiptStatusDtoToReceiptStatus(
        ReceiptStatusDto receiptStatusDto) {
